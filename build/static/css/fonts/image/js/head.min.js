!(function (t, e) {
  ...
  function r(t) {
    void 0 !== t.length
      ...
      void 0 === window._progressjsIntervals &&
  ...
  function e() {
    void 0 !== this._onBeforeStartCallback &&
      this._onBeforeStartCallback.call(this),
      function () {
        if (!document.querySelector(".progressjs-container")) {
          var t = document.createElement("div");
          (t.className = "progressjs-container"), document.body.appendChild(t);
        }
      }.call(this);
  ...
  function n(t) {
    if (!t.hasAttribute("data-progressjs")) {
      ...
      (s.className = "progressjs-percent"),
        (s.innerHTML = "1%"),
        n.appendChild(s),
        this._options.overlayMode && "body" === t.tagName.toLowerCase()
          ? ((r.style.left = 0),
            (r.style.right = 0),
            (r.style.top = 0),
            (r.style.bottom = 0))
          : ((r.style.left = e.left + "px"),
            ...
            this._options.overlayMode && (r.style.height = e.height + "px")),
        r.appendChild(n),
  ...
  function a(r, n) {
    var s = this;
    100 <= n && (n = 100),
      r.hasAttribute("data-progressjs") &&
        setTimeout(function () {
          void 0 !== s._onProgressCallback &&
            s._onProgressCallback.call(s, r, n),
  ...
  function o() {
    void 0 !== this._onBeforeEndCallback &&
      (!0 === this._options.considerTransition
        ? l(this._targetElement[0]).addEventListener(
            (function () {
              var t,
              ...
              for (t in r) if (void 0 !== e.style[t]) return r[t];
            })(),
    ...
    for (
      var t = parseInt(this._targetElement[0].getAttribute("data-progressjs")),
        e = 0,
        r = this._targetElement.length;
      e < r;
      e++
    ) {
      var n = this._targetElement[e],
  ...
  var i = function (t) {
    if ("object" == typeof t) return new r(t);
    if ("string" != typeof t) return new r(document.body);
    ...
    (i.fn = r.prototype =
      {
        ...
        autoIncrease: function (t, e) {
          return (
            function (t, e) {
              var r = this,
                n = parseInt(
                  this._targetElement[0].getAttribute("data-progressjs")
                );
              void 0 !== window._progressjsIntervals[n] &&
                clearInterval(window._progressjsIntervals[n]),
        ...
        onbeforeend: function (t) {
          if ("function" != typeof t)
            throw new Error(
              "Provided callback for onbeforeend was not a function"
            );
        ...
        onprogress: function (t) {
          if ("function" != typeof t)
            throw new Error(
              "Provided callback for onprogress was not a function"
            );
